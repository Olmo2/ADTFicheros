...
public abstract class FicheroRegB {
	File fichero;
	
	
	

	FicheroRegB(String fich){
	...
	public abstract boolean leerRegistro(Integer num); //Lee un registro y cierra el fichero
	public abstract boolean escribirRegistro(int num); //Escribe en el fichero el registro Jugador
